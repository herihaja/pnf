...
from donnees.views import lister_donnees, ajouter_donnees, editer_donnees,\
    supprimer_donnees, lister_cumuls, ajax_donnees, ajax_cumuls, export_cumuls, export_donnees
